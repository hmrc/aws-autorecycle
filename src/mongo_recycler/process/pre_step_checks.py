...
def get_ami_and_check_all_amis_match(component, aws):
    return assert_amis_match_and_get_ami(component, aws.get_launch_template_image_ids())


def assert_amis_match_and_get_ami(component, launch_template_image_ids):
...
def assert_all_nodes_in_same_replica_set(instances):
